    ...
    return (
        <div className="grid grid-rows-[1fr,10fr,1fr] h-full">
            ...
            <div className="relative">
                <input
                    type="text"
                    className="px-10 py-3 w-full rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500"
                    placeholder="Type your message..."
                />
                <button className="absolute right-4 top-1/2 transform -translate-y-1/2  text-white rounded p-2 hover:bg-green-600 focus:outline-none">
